...
const Button: React.FC<Props> = ({
  ...
  const combineClassName = () => {
    ...
    const classNameString = classNamePrefix ? classNamePrefix + ' ' + defaultClass : defaultClass;

    return overWriteClassName ? overWriteClassName : classNameString + sizeString + maxWidthString;
  };
